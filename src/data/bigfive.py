...
EXPLANATIONS = {
    "big_five_intro": """
    **Модель Big Five (OCEAN)** тут використовується як стабільний психометричний шар профілю.

    Найкращий шлях — імпортувати PDF з 30 facets: так система бачить не лише загальні OCEAN-бали,
    а й детальні підшкали, які точніше впливають на потреби, стрес і побутову сумісність.
    Ручне внесення лишається запасним режимом, якщо PDF недоступний або потрібно вручну перевірити імпорт.
    """,
