...
EXPLANATIONS = {
    ...
    **Модель Big Five (OCEAN)** — це "операційна система" вашої психіки.
    ...
    Ми використовуємо 30-фасетну модель. Ви можете ввести загальні бали (T-scores, 0-100), 
    або розкрити вкладку "Advanced" і ввести детальні бали по кожному фасету (шкала 0-20), 
    якщо ви проходили розширений тест IPIP-NEO.
    """,
